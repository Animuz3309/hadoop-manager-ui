...
export function listNetworks(clusterId) {
  return {
    ...
    promise: (client) => client.get(`/api/clusters/${clusterId}/networks`)
  };
}
...
export function deleteNetwork(clusterId, networkId, container = null) {
  return {
    ...
    promise: (client) => client.del('/api/networks/delete', {params: {cluster: clusterId, network: networkId}})
  };
}
...
export function connectNetwork(clusterId, networkId, container) {
  return {
    ...
    promise: (client) => client.post('/api/networks/connect', {params: {cluster: clusterId, network: networkId, container: container.id}})
  };
}
...
export function disconnectNetwork(clusterId, networkId, container) {
  return {
    ...
    promise: (client) => client.post('/api/networks/disconnect', {params: {cluster: clusterId, network: networkId, container: container.id}})
  };
}
