...
export function getClusterServices(clusterId) {
  return {
    ...
    cluster: clusterId,
    promise: (client) => client.get(`/api/clusters/${clusterId}/services`)
  };
}
...
export function create(service) {
  return {
    ...
    promise: (client) => client.post(`/api/services/create`, {data: service})
  };
}
...
export function deleteService(cluster, service) {
  return {
    ...
    promise: (client) => client.post(`/api/services/delete`, {params: {id: service.id, cluster: cluster}})
  };
}
...
export function scaleService(service, cluster, scale) {
  return {
    ...
    promise: (client) => client.post(`/api/services/scale`, {params: {id: service.id, cluster: cluster, scale: scale}})
  };
}
...
export function getService(clusterId, serviceId) {
  return {
    ...
    promise: (client) => client.get(`/api/services/get`, {params: {id: serviceId, cluster: clusterId}})
  };
}
